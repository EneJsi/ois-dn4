		...
		$.ajax({
	    	...
	    	success: function (data) {
				var party = data.party;
					...
					krogciRes += "<div class='panel-body text-center'><svg width='720' height='120'><circle cx='40' cy='60' r='10'></circle><circle cx='80' cy='60' r='10'></circle><circle cx='120' cy='60' r='10'></circle></svg></div></div></div>";
